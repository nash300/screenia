...
export const legalDocumentLabels: Record<LegalDocumentType, string> = {
  ...
  support_service: "Support and service",
};
...
export const defaultLegalDocuments = [
  ...
  },
  {
    ...
    content: "Screenia använder nödvändiga tekniska cookies och webblagring för inloggning, kontosäkerhet, betalningsflöde, kundportal, adminpanel och displaydrift. Dessa används för att tjänsten ska fungera säkert och kan normalt inte stängas av i tjänsten.\n\nAnalys, marknadsföringspixlar, remarketing eller annan icke-nödvändig spårning får inte aktiveras utan tydligt samtycke, dokumenterat ändamål och möjlighet att neka eller återkalla samtycke.",
    pdf_url: null,
  },
  {
